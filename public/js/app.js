...
document.addEventListener('DOMContentLoaded', function () {
  ...
  removeFromCartButtons.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var pizzaId = btn.dataset.pizzaId;
      removeItemFromCart(pizzaId);
    });
  });
  function removeItemFromCart(pizzaId) {
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/remove-from-cart', {
      pizzaId: pizzaId
    }).then(function (res) {
      console.log(res);
      // Reload the page or update the cart section based on your app's logic
    })["catch"](function (err) {
      console.error(err);
    });
  }
